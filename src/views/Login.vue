  ...
  <v-container class="login-container fill-height" fluid>
    <v-row justify="center" align="center" class="fill-height">
      <v-col cols="12" sm="8" md="6" lg="4" xl="3">
        <v-card class="login-card elevation-12" rounded="xl" :loading="authStore.isLoading">
                    ...
                    <v-list density="compact">
                      <v-list-item>
                        <v-list-item-title class="text-caption"
                          >admin@test.com / 123456</v-list-item-title
                        >
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-title class="text-caption"
                          >user@test.com / password</v-list-item-title
                        >
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-title class="text-caption"
                          >demo@test.com / 123456</v-list-item-title
                        >
                      </v-list-item>
                    </v-list>
                  </v-expansion-panel-text>
